...
<head>
    ...
    <link rel="stylesheet" href="${path}/css/slider.css" type="text/css" media="screen" property="" />
    <link href="${path}/css/style7.css" rel="stylesheet" type="text/css" media="all" />
    <!-- Owl-carousel-CSS -->
    <link href="${path}/css/owl.carousel.css" rel="stylesheet">

    <link rel="stylesheet" href="${path}/css/team.css" type="text/css" media="all" />
...
<div class="banner_top" id="home">
    <div class="wrapper">
        <div class="agile_banner_text_info">
            <h1><i class="fa fa-camera-retro" aria-hidden="true"></i> <span>Creative</span><a href="index.jsp">Megapixel</a></h1>
        </div>
        <div class="gallery">
            <div class="gallery__img-block  ">
                ...
                <img src="${path}/images/banner1.jpg" thumb-url="images/banner11.jpg" alt="" />
            </div>
            <div class="gallery__img-block  current">
				<span class="">
				OUTDOOR SESSION
			</span>
                <img src="${path}/images/banner2.jpg" thumb-url="images/banner22.jpg" alt="" />
            </div>
            <div class="gallery__img-block  ">
				<span class="">
			   PORTRAIT SESSION
			</span>
                <img src="${path}/images/banner3.jpg" thumb-url="images/banner33.jpg" alt="" />
            </div>
            <div class="gallery__img-block  ">
				<span class="">
				STUDIO SESSION
			</span>
                <img src="${path}/images/banner4.jpg" thumb-url="images/banner44.jpg" alt="" />
            </div>
            <div class="gallery__img-block  ">
				<span class="">
			   ULTIMATE SESSION
			</span>
                <img src="${path}/images/banner5.jpg" thumb-url="images/banner55.jpg" alt="">
            </div>
            <div class="gallery__img-block  ">
				<span class="">
			  ARCHIVE PHOTOGRAPHS
			</span>
                <img src="${path}/images/banner6.jpg" thumb-url="images/banner66.jpg" alt="" />
            </div>
            <div class="gallery__img-block  ">
				<span class="">
				 PORTRAIT SESSION
...
<div class="about" id="welcome">
    <div class="container">
        <div class="wthree_head_section">
            ...
            <h3 class="agile_tittle"><i class="fa fa-bullhorn" aria-hidden="true"></i> <span>About</span>Photography</h3>
        </div>
        <div class="agile_wthree_inner_grids">
            ...
            <div class="col-md-6 about_agileinfo_grid_imgs">
                ...
                <img src="${path}images/banner6.jpg" alt="" />
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-info">
                    <h4>Megapixel</h4>
                    <img src="${path}/images/banner2.jpg" alt=" " class="img-responsive" />
...
<div class="stats" id="stats">
    <div class="container">
        <div class="wthree_head_section">
            <h3 class="agile_tittle"><i class="fa fa-bullhorn" aria-hidden="true"></i> <span>Our</span>Achivements</h3>
        </div>
        <div class="agile_wthree_inner_grids">
...
<div class="skills-agileinfo" id="skills">
    ...
    <div class="col-md-6 bar-grids  w3-agile">
        <div class="wthree_head_section two">
            <h3 class="agile_tittle two"><i class="fa fa-bar-chart" aria-hidden="true"></i> <span>Our</span>Skills</h3>
        </div>
        <div class="wthree_skills">
            ...
            <h6>Photos Taken<span> 95% </span></h6>
            <div class="progress">
                <div class="progress-bar progress-bar-striped active" style="width: 95%">
                </div>
            </div>
...
<div id="team" class="team featured_services">
    <div class="container">
        <div class="wthree_head_section">
            <h3 class="agile_tittle"><i class="fa fa-bullhorn" aria-hidden="true"></i> <span>Our</span>Photographers</h3>
        </div>
        <div class="agile_wthree_inner_grids">
            <div class="col-md-4 w3_agile_team_grid_info">
                <img src="${path}/images/t1.jpg" alt=" " class="img-responsive" />
                <h3>Jane Mycle </h3>
                <p>Photographer</p>
            ...
            <div class="col-md-4 w3_agile_team_grid_info">
                <img src="${path}/images/t2.jpg" alt=" " class="img-responsive" />
                <h3>Amanda Seylon </h3>
                <p>Photographer</p>
                <div class="agileits_w3layouts_nav_right team_agile _icons">
                    <ul>
            ...
            <div class="col-md-4 w3_agile_team_grid_info">
                <img src="${path}/images/t3.jpg" alt=" " class="img-responsive" />
                <h3>Laura Mark</h3>
                <p>Photographer</p>
                <div class="agileits_w3layouts_nav_right team_agile _icons">
                    <ul>
...
<div class="services" id="services">
    <div class="container">
        <div class="wthree_head_section">
            <h3 class="agile_tittle"><i class="fa fa-cogs" aria-hidden="true"></i> <span>Our</span>Services</h3>
        </div>
        <div class="agile_wthree_inner_grids">
            ...
            <div class="portfolio-grids_main">
                <div class="col-md-6 portfolio-grids" data-aos="zoom-in">
                    <a href="images/g1.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
                        <img src="${path}/images/g1.jpg" class="img-responsive" alt="w3ls" />
                ...
                <div class="col-md-6 portfolio-grid_left">
                    <div class="col-md-6 portfolio-grids" data-aos="zoom-in">
                        <a href="images/g5.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
                            <img src="${path}/images/g5.jpg" class="img-responsive" alt="w3ls" />
                            <div class="b-wrapper">
                                <i class="fa fa-magic" aria-hidden="true"></i>
                    ...
                    <div class="col-md-6 portfolio-grids" data-aos="zoom-in">
                        <a href="images/g4.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
                            <img src="${path}/images/g4.jpg" class="img-responsive" alt="w3ls" />
                            <div class="b-wrapper">
                                <i class="fa fa-magic" aria-hidden="true"></i>
            ...
            <div class="portfolio-grids_main">
                ...
                <div class="col-md-6 portfolio-grid_left">
                    <div class="col-md-6 portfolio-grids" data-aos="zoom-in">
                        <a href="images/g6.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
                            <img src="${path}/images/g6.jpg" class="img-responsive" alt="w3ls" />
                            <div class="b-wrapper">
                                <i class="fa fa-magic" aria-hidden="true"></i>
                    ...
                    <div class="col-md-6 portfolio-grids" data-aos="zoom-in">
                        <a href="images/g3.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
                            <img src="${path}/images/g3.jpg" class="img-responsive" alt="w3ls" />
                            <div class="b-wrapper">
                                <i class="fa fa-magic" aria-hidden="true"></i>
                ...
                <div class="col-md-6 portfolio-grids" data-aos="zoom-in">
                    <a href="images/g2.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
                        <img src="${path}/images/g2.jpg" class="img-responsive" alt="w3ls" />
                        <div class="b-wrapper two">
                            <i class="fa fa-magic" aria-hidden="true"></i>
...
<div class="agile_testimonials" id="testimonials">
    <div class="container">
        <div class="wthree_head_section test">
            <h3 class="agile_tittle"><i class="fa fa-bullhorn" aria-hidden="true"></i> <span>Our</span> Testimonials</h3>
        </div>
                ...
                <div id="owl-demo2" class="owl-carousel">
                    <div class="agile">
                        <div class="test-grid">
                            ...
                            <div class="col-md-3 test-grid2">
                                <img src="${path}/images/t1.jpg" alt="" class="img-r">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="agile">
                        <div class="test-grid">
                            ...
                            <div class="col-md-3 test-grid2">
                                <img src="${path}/images/t2.jpg" alt="" class="img-r">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="agile">
                        <div class="test-grid">
                            ...
                            <div class="col-md-3 test-grid2">
                                <img src="${path}/images/t3.jpg" alt="" class="img-r">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
...
<div class="contact" id="contact">
    <div class="col-md-6 contact_img_agile">
    </div>
    <div class="col-md-6 contact-form agile_inner_grids">
        <div class="wthree_head_section two">
            <h3 class="agile_tittle two"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> <span>Our</span>Contact</h3>
        </div>
...
<div class="w3l_footer">
    <div class="container">
        <div class="col-md-4">
            <h2><a href="index.html"><i class="fa fa-camera-retro" aria-hidden="true"></i> Megapixel</a></h2>
        </div>
        <div class="col-md-8 botttom-nav-agileits">
            <ul class="nav-w3ls">
                <li><a class="scroll" href="#home">Home</a></li>
                <li><a class="scroll" href="#welcome">About</a></li>
        ...
        <div class="clearfix"> </div>
        <p class="agileits_w3ls_copyright">Copyright &copy; 2017.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
...
<script src="${path}/js/jquery.countup.js"></script>
<script>
    $('.counter').countUp();
</script>
<!-- //stats -->
