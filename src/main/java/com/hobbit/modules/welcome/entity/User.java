...
public class User {
    ...
    public Integer getInstallapp() {
        return installapp;
    }

    public void setInstallapp(Integer installapp) {
    ...
    public Integer getCloseDaily() {
        return closeDaily;
    }

    public void setCloseDaily(Integer closeDaily) {
    ...
    public void setFacebookCode(String facebookCode) {
        this.facebookCode = facebookCode == null ? null : facebookCode.trim();
    }
